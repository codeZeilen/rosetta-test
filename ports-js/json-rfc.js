...
jsonSuite.placeholder("file-contents", (env, fileName) => {
    try {
        return readFileSync(path.join("suites", "json-rfc-fixtures", fileName), "utf8");
    } catch (error) {
